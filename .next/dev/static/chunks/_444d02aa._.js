...
function LoginPage() {
    ...
    const handleLogin = async (credentials)=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$factory$2f$crudFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$crud"].post("organization/login", {
            ...
            if (token && userData) {
                ...
                enqueueSnackbar(`Welcome back, ${userData.name}!`, {
                    variant: "success"
                });
...
_s(LoginPage, "o4sqH02WkldehrL6XeEa9LKJT30=", false, function() {
    return [
...
//# sourceMappingURL=_444d02aa._.js.map