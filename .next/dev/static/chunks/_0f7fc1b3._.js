...
class StudentsService {
    ...
    static async getStudent(id) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$factory$2f$crudFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$crud"].get(`retrieve/organization/student/${id}`);
            if (response.data) {
                return this.transformStudent(response.data);
            }
            return null;
...
_s(UserListTable, "Z7Pi9wumzEa6IbNsjLGBjGjO+tw=", false, function() {
    return [
...
_c = UserListTable;
var _c;
__turbopack_context__.k.register(_c, "UserListTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0f7fc1b3._.js.map