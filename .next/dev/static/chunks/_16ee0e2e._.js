...
class StudentsService {
    ...
    static async updateStudent(id, studentData) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$factory$2f$crudFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$crud"].put(`update/organization/student/${id}`, studentData);
            if (response.data) {
                return this.transformStudent(response.data);
            }
...
//# sourceMappingURL=_16ee0e2e._.js.map