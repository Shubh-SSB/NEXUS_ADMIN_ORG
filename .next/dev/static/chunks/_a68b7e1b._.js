...
class StudentsService {
    ...
    static async fetchStudents() {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$factory$2f$crudFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$crud"].get("retrieve/organization/students");
    ...
    static async fetchStudentsWithMeta() {
        try {
            ...
            if (response.data?.rows && Array.isArray(response.data.rows)) {
                return {
                    // @ts-ignore
                    students: response.data.rows.map(this.transformStudent),
                    //   @ts-ignore
                    totalRecords: response.data.totalRecords || response.data.rows.length
                };
            } else {
                console.warn("Unexpected API response format:", response);
                return {
...
const useStudents = ()=>{
    ...
    const fetchStudents = async ()=>{
        try {
            setIsLoading(true);
            setError(null);
            const studentsData = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$studentsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StudentsService"].fetchStudents();
...
_s(useStudents, "mhAgvG0Bo7PtH90JFoikAvOkd6g=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function UserListTable() {
    _s();
    const { students, isLoading, error, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useStudents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStudents"])();
    if (isLoading) {
...
_s(UserListTable, "Estt8UI44DP2/1hnAAX0RHd+VrE=", false, function() {
    return [
...
//# sourceMappingURL=_a68b7e1b._.js.map