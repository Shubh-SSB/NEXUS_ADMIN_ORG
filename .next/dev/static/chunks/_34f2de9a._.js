...
var _s = __turbopack_context__.k.signature();
;
const useLogin = (onLogin, onForgotPassword, error)=>{
    _s();
...
_s(useLogin, "bl08oOv40tBu5qnVVJFNogpQ+Ik=");
const loginAPI = {
...
const createLoginHandler = (config)=>{
    return async (formData)=>{
        try {
            // Transform request if needed
            const requestBody = config.transformRequest ? config.transformRequest(formData) : {
...
const loginHandlers = {
    // Standard REST API
    standard: (apiUrl)=>createLoginHandler({
            apiUrl,
            onSuccess: (data)=>{
    ...
    // API with custom headers (e.g., API key)
    withApiKey: (apiUrl, apiKey)=>createLoginHandler({
            apiUrl,
            headers: {
                "X-API-Key": apiKey
            }
        }),
    // Laravel/PHP API format
    laravel: (apiUrl)=>createLoginHandler({
            apiUrl,
    ...
    // .NET Core API format
    dotnet: (apiUrl)=>createLoginHandler({
            apiUrl,
            transformRequest: (formData)=>({
                    Email: formData.email,
                    Password: formData.password,
    ...
    // Firebase/Custom format
    firebase: (apiUrl)=>createLoginHandler({
            apiUrl,
            transformRequest: (formData)=>({
                    email: formData.email,
                    password: formData.password,
...
const LoginForm = ({ onLogin, onForgotPassword, onSignUp, isLoading = false, error })=>{
    _s();
    const { formData, displayError, handleInputChange, handleSubmit, handleForgotPassword } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$functions$2f$login$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLogin"])(onLogin, onForgotPassword, error);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "h-auto rounded-2xl tracking-wider w-96 border-2 backdrop-blur-md bg-black/25 relative flex flex-col items-center justify-center p-8 z-10",
        children: [
...
_s(LoginForm, "cfXM7NolLgRmuqnWLsMixZlsfgM=", false, function() {
    return [
...
//# sourceMappingURL=_34f2de9a._.js.map