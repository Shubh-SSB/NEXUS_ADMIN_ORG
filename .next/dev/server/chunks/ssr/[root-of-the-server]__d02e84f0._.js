...
class StudentsService {
    ...
    static async getStudent(id) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$factory$2f$crudFactory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["$crud"].get(`retrieve/organization/student/${id}`);
            if (response.data) {
                return this.transformStudent(response.data);
            }
            return null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d02e84f0._.js.map