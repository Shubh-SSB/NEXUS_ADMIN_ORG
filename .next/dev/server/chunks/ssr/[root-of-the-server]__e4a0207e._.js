...
class StudentsService {
    ...
    static async fetchStudents() {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$factory$2f$crudFactory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["$crud"].get("retrieve/organization/students");
...
const useStudents = ()=>{
    ...
    const fetchStudents = async ()=>{
        try {
            setIsLoading(true);
            setError(null);
            const studentsData = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$studentsService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StudentsService"].fetchStudents();
...
function UserListTable() {
    const { students, isLoading, error, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useStudents$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStudents"])();
    if (isLoading) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e4a0207e._.js.map