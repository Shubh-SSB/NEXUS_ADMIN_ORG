...
"[project]/components/users/user-list-table-service.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserListTableWithService() {
    ...
    const loadStudents = async ()=>{
        try {
            setIsLoading(true);
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$studentsService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StudentsService"].fetchStudents();
            setStudents(data);
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ab936dc._.js.map